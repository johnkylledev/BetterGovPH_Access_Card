  ...
  return (
    <div className="perspective-1000" style={{ perspective: '1000px' }}>
      ...
      >
        ...
        {/* Security Pattern (Guilloche / Interlocking circles style for Government IDs) */}
        <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.06]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="guilloche" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
              ...
              <circle cx="0" cy="30" r="20" fill="none" stroke="#ffffff" strokeWidth="1" />
              <circle cx="60" cy="30" r="20" fill="none" stroke="#ffffff" strokeWidth="1" />
              <circle cx="30" cy="0" r="20" fill="none" stroke="#ffffff" strokeWidth="1" />
              <circle cx="30" cy="60" r="20" fill="none" stroke="#ffffff" strokeWidth="1" />
            </pattern>
          </defs>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] opacity-[0.05] pointer-events-none mix-blend-plus-lighter">
          <svg id="Design" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
            <defs>
        ...
        <div className="relative z-10 flex flex-col items-center w-full" style={{ transform: 'translateZ(20px)' }}>
          ...
          <div className="text-center">
            <p className="text-xs font-sans tracking-[0.25em] text-white font-semibold uppercase mt-1">BetterGovPH</p>
          </div>
        </div>
        ...
        <div className="relative z-10 mt-auto flex flex-col items-center w-full" style={{ transform: 'translateZ(40px)' }}>
          ...
          <div className="flex flex-col items-center space-y-1.5 text-center">
            <p className="text-[9px] font-sans tracking-[0.1em] text-white/60 pt-0.5">
              bettergov.ph
            </p>
          </div>
        </div>
